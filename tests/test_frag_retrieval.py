...
if __name__=='__main__':
    ...
    def testrun(scorers_list=[], scorers_settings=[]):
...
if __name__=='__main__':
    ...
    test_output_folder='e:/Imperial/TestDB/Output_testnewPubChem';
    
    fingerprint_model_path='e:/Imperial/TestDB/SVM_Train';    
    ...
    remove_low_precision_spectra(0.01);
    ...
    with PeakAnnotator(dbfile, fingerprint_model_path, nproc) as peak_annotator:
        ...
        logit('dH for Fragmenter: [0], precision 0.01, analysis type 0');
        logtime();
        testrun(['FragPrintScorer'],[([0], 0.01, 1, 0)]);
    
        logit('dH for Fragmenter: [0,1], precision 0.01, analysis type 0');
        logtime();
        ...
        logit('dH for Fragmenter: [0,-1,1], precision 0.01, analysis type 0');
        logtime();
        testrun(['FragPrintScorer'],[([0,-1,1], 0.01, 1, 0)]);


        logit('dH for Fragmenter: [0], precision 0.01, analysis type 1');
        logtime();
        testrun(['FragPrintScorer'],[([0], 0.01, 1, 1)]);
    
        logit('dH for Fragmenter: [0,1], precision 0.01, analysis type 1');
        logtime();
        ...
        logit('dH for Fragmenter: [0,-1,1], precision 0.01, analysis type 1');
        logtime();
        testrun(['FragPrintScorer'],[([0,-1,1], 0.01, 1, 1)]);
        
        
        logit('dH for Fragmenter: [0], precision 0.01, analysis type 2');
        logtime();
        testrun(['FragPrintScorer'],[([0], 0.01, 1, 2)]);
    
        logit('dH for Fragmenter: [0,1], precision 0.01, analysis type 2');
        logtime();
        ...
        logit('dH for Fragmenter: [0,-1,1], precision 0.01, analysis type 2');
        logtime();
