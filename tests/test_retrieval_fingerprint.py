...
if __name__=='__main__':
    ...
    test_output_folder='e:/Imperial/TestDB/HDF5_FingerFrag20ppm_metaonly_andformula_or_element_composition_largedb2_redone2';
    ...
    for precision in precisions:                 
        ...
        with PeakAnnotator(dbfiles, fingerprint_model_path, nproc) as peak_annotator:
            ...
            logit('FragPrint 20 ppm, FingerPrint, no metabolite likeness 2 class raw, use formula');
            
            testrun(['FragPrintScorer','FingerPrintScorer'],[([0,-1,1], 20, 0, 1),[]], batch, header = 'Frag+Finger+formula', use_formula = True);
            
            
            logit('FragPrint 20 ppm, FingerPrint, no metabolite likeness 2 class raw, use elements');
            
            testrun(['FragPrintScorer','FingerPrintScorer'],[([0,-1,1], 20, 0, 1),[]], batch, header = 'Frag+Finger+elements', use_elements = True);
    

            logit('FragPrint 20 ppm, FingerPrint, no metabolite likeness 2 class raw, baseline');
            
            testrun(['FragPrintScorer','FingerPrintScorer'],[([0,-1,1], 20, 0, 1),[]], batch, header = 'Frag+Finger');            
            
            
            
            logit('FragPrint 20 ppm, no metabolite likeness 2 class raw, use formula');
            
            testrun(['FragPrintScorer'],[([0,-1,1], 20, 0, 1)], batch, header = 'Frag+formula', use_formula = True);
            
            
            logit('FragPrint 20 ppm, no metabolite likeness 2 class raw, use elements');
            
            testrun(['FragPrintScorer'],[([0,-1,1], 20, 0, 1)], batch, header = 'Frag+elements', use_elements = True);
    

            logit('FragPrint 20 ppm, no metabolite likeness 2 class raw, baseline');
            
            testrun(['FragPrintScorer'],[([0,-1,1], 20, 0, 1)], batch, header = 'Frag');            
            
            
            logit('FingerPrint, no metabolite likeness 2 class raw, use formula');
            
            testrun(['FingerPrintScorer'],[[]], batch, header = 'Finger+formula', use_formula = True);
            
            
            logit('FingerPrint, no metabolite likeness 2 class raw, use elements');
            
            testrun(['FingerPrintScorer'],[[]], batch, header = 'Finger+elements', use_elements = True);
    

            logit('FingerPrint, no metabolite likeness 2 class raw, baseline');
            
            testrun(['FingerPrintScorer'],[[]], batch, header = 'Finger');            
