...
fileslist = [y for x in os.walk(inpath) for y in glob(os.path.join(x[0], '*.dat'))];
...
for infile in fileslist:
    ...
    print(dirname);
    outpath='d:/Imperial/tempDB/PlantCyc'+dirname;
