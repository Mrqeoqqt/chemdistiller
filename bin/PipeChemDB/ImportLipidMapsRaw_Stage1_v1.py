...
infile='d:/RawData/LipidMaps/LMSDFDownload28Jun15FinalAll.sdf';
outpath='d:/Imperial/tempDB/LipidMaps';
...
for mol in pybel.readfile('sdf',infile):
    ...
    idx=mol.data['LM_ID'].replace('LM','');
    if 'COMMON_NAME' in mol.data:
        names=mol.data['COMMON_NAME'];
    elif 'SYSTEMATIC_NAME' in mol.data:
        names=mol.data['SYSTEMATIC_NAME'];
    else:
        names='N/A';
