...
"""
#%%
inpath='e:/Imperial/tempDB/BovineMetabolomeDB';
outpath='e:/Imperial/tempDB/BovineMetabolomeDB/FragsnoH';
...
for i in range(0,1300):
    if i%8==batch:
      for j in range(0,10):
        for k in range(0,10):
            for l in range(0,10):
                if isfile(inpath+'/Neutral'+'/%s/%s/%s/%s.st2'%(i,j,k,l)):
...
for i in range(0,1300):
    if i%8==batch:
      for j in range(0,10):
        for k in range(0,10):
            for l in range(0,10):
                if isfile(inpath+'/Negative'+'/%s/%s/%s/%s.st2'%(i,j,k,l)):
...
for i in range(0,1300):
    if i%8==batch:
      for j in range(0,10):
        for k in range(0,10):
            for l in range(0,10):
                if isfile(inpath+'/Positive'+'/%s/%s/%s/%s.st2'%(i,j,k,l)):
