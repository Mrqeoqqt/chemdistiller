...
dbpath='g:/DB_HDF5_MetaboliteLikeness_twoclass_nonmeta';
outfile='g:/DB_HDF5_MetaboliteLikeness_twoclass_nonmeta/likeness.log';
   
    
if __name__=='__main__':
    modelname='g:/MetaboliteLikeness/results3_home3/model_9.model'
